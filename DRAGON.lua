...
print([[
                                                         ...
                                                         dddddddd        
   SSSSSSSSSSSSSSS                     iiii              d::::::d  iiii  
 SS:::::::::::::::S                   i::::i             d::::::d i::::i 
S:::::SSSSSS::::::S                    iiii              d::::::d  iiii  
S:::::S     SSSSSSS                                      d:::::d         
S:::::S              aaaaaaaaaaaaa   iiiiiii     ddddddddd:::::d iiiiiii 
S:::::S              a::::::::::::a  i:::::i   dd::::::::::::::d i:::::i 
 S::::SSSS           aaaaaaaaa:::::a  i::::i  d::::::::::::::::d  i::::i 
  SS::::::SSSSS               a::::a  i::::i d:::::::ddddd:::::d  i::::i 
    SSS::::::::SS      aaaaaaa:::::a  i::::i d::::::d    d:::::d  i::::i 
       SSSSSS::::S   aa::::::::::::a  i::::i d:::::d     d:::::d  i::::i 
            S:::::S a::::aaaa::::::a  i::::i d:::::d     d:::::d  i::::i 
            S:::::Sa::::a    a:::::a  i::::i d:::::d     d:::::d  i::::i 
SSSSSSS     S:::::Sa::::a    a:::::a i::::::id::::::ddddd::::::ddi::::::i
S::::::SSSSSS:::::Sa:::::aaaa::::::a i::::::i d:::::::::::::::::di::::::i
...
sudo_users = {SUDO,1965534755,1549578895,1372188096,1770493345}   
...
local UserName = (data.username_ or "S_a_i_d_i")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'المـبــرمـج ديشـا', url="t.me/XxDesha86Xx"}},
{{text = 'بــوت تواصـل ديشـا',url="t.me/desha100_BOT"}}, 
...
{{text = 'المـبـرمــج جـابــوا', url="t.me/J_A_B_W_A"}},
{{text = 'بــوت تواصـل جـابــوا',url="t.me/Bot_JABWA_Bot"}}, 
{{text = 'بــار توصـل تيم الصـعيدي',url="t.me/TEM_SAIDI"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'حروف بالصور','كتبات بالصور'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'بوستات بالصور',' معلومه'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'خلفيات رومانسيه','صور كرتون'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'رامزيات ولاد','رامزيات بنات'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'صور ولاد ','صور بنات'},
{'⩹━━━━━━❪ركن الافلام❫━━━━━━⩺'},
{'افلام اجنبي',' افلام كرتون'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'افلام عربي','غنيلي بفديو'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'غنيلي'},
{'⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺'},
{'استوري ','روايات'},
...
if DevSoFi(msg) then
local bl = 'مرحبا بك في كيب المطور الاساسي بي سورس صعيدي'
local keyboard = {
...
local Text = ' ☽ تم ارسال الملصق من ⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺\n - '..Name
...
{{text = '`ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ´', url="t.me/Bot_JABWA_Bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/S_a_i_d_i)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناة السورس', url="t.me/S_a_i_d_i"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
المبرمج طه لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
send(msg.chat_id_,0," ☽ الـعـضو  : {["..data.first_name_.."](T.ME/S_a_i_d_i)}\n ☽ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☽ عذرا  ⇇{["..data.first_name_.."](T.ME/S_a_i_d_i)}\n ☽ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'المبرمج طه' or text == 'طه' or text == 'taha 7x' or text == '²مبرمج السورس' then
local Text = [[
...
if text == 'المبرمج عمر' or text == 'عمر' or text == 'عموري' or text == '³مبرمج السورس' then
local Text = [[
عمر مبرمج السورس³ لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
if text == 'المبرمج ديشا' or text == 'ديشا' or text == 'عوز انصب بوت' or text == '⁴مبرمج السورس' then
local Text = [[
ديشا مبرمج السورس⁴ لو حابب تتواصل معاه
اتبع الزر إلى تحت ⇈⇊
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '• ᴅᴇᴠ ᴅᴇѕʜᴀ',url="t.me/XxDesha86Xx"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '📖رواية "بعد النسيان"', url="https://t.me/t.me/S_a_i_d_i"}},
{{text = '📖كتاب في حضرة الجن', url="https://t.me/https://t.me/t.me/S_a_i_d_i"}},
{{text = '📖رواية "واختفى كل شئ"', url="https://t.me/t.me/S_a_i_d_i"}},
{{text = '📖رواية "نيلوفر أسود"', url="https://t.me/t.me/S_a_i_d_i"}},
{{text = '📖رواية"جثة في الفندق"', url="https://t.me/t.me/S_a_i_d_i"}},
{{text = '📖رواية "في القطار السريع"', url="https://t.me/t.me/S_a_i_d_i"}},
...
{{text = 'عمر مبرمج السورس',url="t.me/BOT3mora"}},
{{text = 'ديشا مبرمج السورس',url="t.me/XxDesha86Xx"}},
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
ght = math.random(1,33);  
local Text ='إليك صور كرتون إنمي 🌚❤️'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text =  '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´' ,url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
ght = math.random(1,33);  
local Text ='مرحبا اليك خلفيه جميله يا بتاع الحب 🌚❤️'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text =  '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´' ,url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
ght = math.random(1,33);  
local Text ='مرحبا اليك فلام من الافلام الاجنبيه 🌚❤️'
keyboard = {}   
keyboard.inline_keyboard = {  
{{text =  '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´' ,url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
ght = math.random(1,33);  
local Text ='مرحبا اليك فلام عربي من افضل الافلام 🌚❤️'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text =  '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´' ,url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
ght = math.random(1,33);  
local Text ='تم أختيار الفيديو الأجنبي إليك الأن 🌚❤️'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text =  '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´' ,url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
ght = math.random(1,33);  
local Text ='تم اختيار اغنيه عشوائية من اغني بفديو 🌚❤️'  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text =  '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´' ,url="t.me/S_a_i_d_i"}},
{{text = 'أضغط لاضافه ألبوت لمجموعتك 𖠪' ,url="t.me/"..dofile("./Banda.lua").botUserName.."?startgroup=start"}}, 
...
[ᴛᴡᴀѕʟ sᴏᴜʀᴄᴇ](t.me/Bot_JABWA_Bot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '`sᴏᴜʀᴄᴇ sᴀɪᴅɪ´', url="t.me/S_a_i_d_i"}}, 
...
if tonumber(userid) == tonumber(1770493345) then  
send(msg.chat_id_, msg.id_, " ☽ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local Text = " 𖢄 منشئ الجروب  ⇇ ["..b.first_name_.."](tg://user?id="..b.id_..")\n"..getbio(b.id_):gsub('لايوجد','')
local msg_id = msg.id_/2097152/0.5
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𖢄 '..b.first_name_..' 𖢄', url="t.me/"..UserName}}, 
}
...
sendText(b.id_," 𖢄 مرحبا عزيزي المنشئ هناك شخص يريدك \n 𖢄 الشخص  {"..Name.."}\n 𖢄 اسم الجروب {"..NameChat.."}\n 𖢄 ايدي الجروب {"..msg.chat_id_.."}\n 𖢄 رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end,nil)
end
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☽ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'S_a_i_d_i')..')'
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝🌍 ](t.me/S_a_i_d_i)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"الردود معطله  يرجاء كتب تفعيل ردود السورس") 
return false  
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..🌚♥️](t.me/S_a_i_d_i)')
return false
end

if text == "ويت"  or text == "خمسه وجاي" then
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_,"  ") 
return false  
end
send(msg.chat_id_,msg.id_, '[اي ثقافه دي 😹](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[كفيه شقط سيب حاجه لغيرك ❤️😂](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[محات حياتي يروحي..🌚💔](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[دايما ياحبيبي..🌚💜](t.me/S_a_i_d_i)')
return false
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق..🥰❤️](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام..🌚🖤](t.me/S_a_i_d_i)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..🥺❤️](t.me/S_a_i_d_i)')
return false
end
end
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n|• 𝚄??𝙴𝚁 ↬  ↝'..username..'↜     ↝❤️\n|• ??𝚂𝙶𝚂↬  ↝'..Msguser..'↜     ↝❤️\n|• 𝚁𝙰𝙽𝙺↬ ↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜     ↝❤️\n|• 𝙸𝙳↬   ↝'..msg.sender_user_id_..'↜    ↝❤️\n|• 𝒄𝒉↬  ↝@S_a_i_d_i↜     ↝❤️\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n|• 𝚄𝚂𝙴𝚁 ↬  ↝'..username..'↜    ↝❤️\n|• 𝙼𝚂𝙶𝚂↬ ↝'..Msguser..'↜.   ↝❤️\n|• 𝚁𝙰𝙽𝙺↬ ↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜    ↝❤️\n|• 𝙸𝙳↬  ↝'..msg.sender_user_id_..'↜    ↝❤️\n|• 𝒄𝒉↬   ↝@S_a_i_d_i↜    ↝❤️\n')
else
...
- رسائلڪ  الطيفهہَ ⁞ #msgs ❤️ ٬
- رتبتڪ الحلوه ⁞ #stast  ❤️٬
- سحڪاتڪ الفول ⁞ #edit ❤️ ٬
- 𝗖𝗛 - ↝@S_a_i_d_i↜ 💞.
]],
[[
...
local Text = [[
 ...
 تحت لي في الزر الأسفل⩹━━━━⊶❲𖥳 𝐒𝐀𝐈𝐃𝐈 𖥳❳⊷━━━━⩺
