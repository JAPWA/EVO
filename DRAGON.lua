"لو خيروك | تعيش حياتك كلها فالشتاء ولا فالصيف🙄?",
"لو خيروك | تعيش فالجونه ولا الساحل🙄?",
"لو خيروك | تكون غني وتموت بعد3ايام ولا تكون فقير وتعيش50 سنه فوق عمرك🙄?",
"لو خيروك | تكسب صاحب مصلحه ولا صاحب المصلحه🙄?",
"لو خيروك | تقتل دب او تتخانق مع نمر🙄?",
...
"دوله بحرف⇐ف",
"طائر بحرف⇐ع",
"منطقه فالبحر مشهوره بالكوارث بحرف⇐م",
"فاكه بحرف⇐ف",
"حيوان برمائي بحرف⇐ب",
"حيوان مائي بحرف⇐د",
"لعبه بحرف⇐ب",
...
local TWEET_Msg = { 
"((✭╭──── ● «S T A R» ● ────╮✭))",
"اهلا بك عزيزي في اسعار سورس ستار",
"لو عايز بوت بكل حقوقك علي سورس ستار بكل المميزات⇐25جنيه",
"لو عايز سورس ليك بمميزات زي الي فالسورس⇐200جنيه",
"لو عايز سورس ليك بمميزات عاديه⇐150جنيه",
...
if text == '╭──── ● «S T A R» ● ────╮' or text == '╰──── ● «S T A R» ● ────╯' then
local Text = [[ 
╭──── ● «S T A R» ● ────╮
((❃WELCOM ON SOURCE STAR❃))
...
if text == 'بوت التواصل' then
local Text = [[ 
[T W A S E L](t.me/Sourcybot)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'TWASEL STAR ', url="t.me/Sourcybot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب ستار' or text == 'العاب متطوره' then  
local Text = [[  
...
if text == 'تفعيل ستوري' and CoSu(msg) then   
if database:get(bot_id..'sing:for:me'..msg.chat_id_) then
Text = ' ✯  تم تفعيل امر ستوري الان ارسل ستوري'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' ✯  بالتاكيد تم تفعيل امر ستوري تستطيع ارسال ستوري'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل ستوري' and CoSu(msg) then  
if not database:get(bot_id..'sing:for:me'..msg.chat_id_) then
database:set(bot_id..'sing:for:me'..msg.chat_id_,true)  
Text = '\n ✯  تم تعطيل امر ستورس'
else
Text = '\n ✯  بالتاكيد تم تعطيل امر ستوري'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
local DRAGON_Msg = {
'اسمي  '..Namebot..' يثكر🤤💚',
'اسمي '..Namebot..' يلوحي🙈❤️',
'اسمي  '..Namebot..' يقلبي🌚🌹',
'اسمي  '..Namebot..' يقمر 🐭🤍',
'اسمي  '..Namebot..' يوتقه 🥺❤️',
'اسمي  '..Namebot..' يعم 😒',
'مقولت اسمي '..Namebot..' في اي 🙄',
'اسمي الكيوت '..Namebot..' 🌝💘',
'اسمي  '..Namebot..' يمياتي🧸♥️',
'اسمي  '..Namebot..' يمزتي🙈🍑',
}
...
if text == "يلا بينا" or text == "هيا بنا"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "هيا لنبدأ" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "ماشي" or text == "هيا"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {" يا الهي هذا البيت ضخم ومخيف هيا لنذهب للخارج انا خائف ❲لو هتكمل ارسل يلا بسرعه ❳"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "يلا بسرعه" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "يلا نساعده" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "يلا نحله بسرعه" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "99" or text == "70" or text == "44" or text == "61" or text == "121" or text == "90" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اشرب كوب مياه بملح,"اتصل بحد من اهلك وقوله انك فالمستشفي مع حبيبتك عشان حامل منك,"روح بات مع حبيبتك","خون حبيبتك وبوس الاكس","اتصل بالاكس قولها عايز احضنك,",اقعد ساعه منغير متمسك الفون{لو حابب تكمل ارسل يلا}"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "يلا " or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "موافق" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "يلا نخرج" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "يلا نروح" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "في اي" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "اي الشفره دي" or text == "حاضر"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
...
if text == "دولفين" or text == "الدولفين"  then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مبروك لقد نجا صديقكم من الموت"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "كلب البحر" or text == "تمساح" or text == "سمكه قرش" or text == "القرش" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اوبس اجابه خاطئه ولقد مات صديقكم بالصخره"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "بتحبو" or text == "بتحب دا" then
